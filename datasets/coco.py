...
def build(image_set, args):
    ...
    PATHS = {
        "train": (img_path / "train2017", 
                anno_path / "annotations" / f'{mode}_train2017.json'),
        "train_reg": (img_path / "train2017", 
                    anno_path / "annotations" / f'{mode}_train2017.json'),
        "val": (img_path / "val2017", 
                anno_path / "annotations" / f'{mode}_val2017.json'),
        "eval_debug": (img_path / "val2017", 
                    anno_path / "annotations" / f'{mode}_val2017.json'),
        "test": (img_path / "test2017", 
