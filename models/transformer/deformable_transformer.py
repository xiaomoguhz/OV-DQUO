...
from models.ov_dquo.utils import (
...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, refpoint_embed, pos_embeds, tgt, attn_mask=None):
        ...
        if self.two_stage_type == "standard":
            ...
            if self.two_stage_add_query_num > 0: # ! false
            ...
            if refpoint_embed is not None:
                ...
                tgt = torch.cat(
                    [tgt, tgt_], dim=1
                )  # ! 关键，将噪声noise box，query与原query box进行了cat
                # ! bs , num_query+dn_number*2, 4
                # ! bs , num_query+dn_number*2, 256
            else:
